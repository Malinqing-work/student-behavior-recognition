...
"}")
        ...
        self.TopLogoInfo.setStyleSheet(u"image: url(:/all/img/logo.png);")
...
"}")
        ...
        if QIcon.hasThemeIcon(iconThemeName):
            ...
            icon.addFile(u"D:/Users/Desktop/科创文档/本科科创/科创结题/代码/Ultralytics-PySide6/Ultralytics-PySide6-main", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.min_sf.setStyleSheet(u"\n"
"QPushButton{\n"
"	image: url(:/all/img/min.png);\n"
...
"        }")
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_classify.sizePolicy().hasHeightForWidth())
        self.pushButton_classify.setSizePolicy(sizePolicy1)
...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_segment.sizePolicy().hasHeightForWidth())
        self.pushButton_segment.setSizePolicy(sizePolicy1)
...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_detect.sizePolicy().hasHeightForWidth())
        self.pushButton_detect.setSizePolicy(sizePolicy1)
...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_pose.sizePolicy().hasHeightForWidth())
        self.pushButton_pose.setSizePolicy(sizePolicy1)
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"\u57fa\u4e8e\u89c6\u9891\u56fe\u50cf\u7684\u8003\u8bd5\u8fc7\u7a0b\u5206\u6790\u7cfb\u7edf", None))
        ...
        self.ToggleBotton_2.setText(QCoreApplication.translate("MainWindow", u"IoU Threshold", None))
